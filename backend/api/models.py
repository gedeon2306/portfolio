...
class MyInfo(models.Model):
    ...
    image = models.ImageField(upload_to='myinfo/photos/', null=True, blank=True)
    cv = models.FileField(upload_to='myinfo/cv/', null=True, blank=True)
...
class Projects(models.Model):
    ...
    doc = models.FileField(upload_to='projects/docs/', null=True, blank=True)
